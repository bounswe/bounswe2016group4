...
public class ConsumptionHistoryActivity extends SearchableActivity {
    ...
    private void addDummyFood(){
        ...
        consumptionHistory.add(new Food(new Server(),"description","Balik",null,null,null,null));
        consumptionHistory.add(new Food(new Server(),"description","Kebap",null,null,null,null));
        consumptionHistory.add(new Food(new Server(),"description","Tatlı",null,null,null,null));
        consumptionHistory.add(new Food(new Server(),"description","Su",null,null,null,null));
        consumptionHistory.add(new Food(new Server(),"description","Kola",null,null,null,null));
        consumptionHistory.add(new Food(new Server(),"description","Sandviç",null,null,null,null));
        consumptionHistory.add(new Food(new Server(),"description","Boza",null,null,null,null));
        consumptionHistory.add(new Food(new Server(),"description","Brokoli",null,null,null,null));
        consumptionHistory.add(new Food(new Server(),"description","Tavuk",null,null,null,null));
    }
